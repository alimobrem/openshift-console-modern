...
function StatusBadge({ resource }: { resource: K8sResource }) {
  ...
  // Don't show badge for resources with no status (ConfigMaps, Secrets, etc.)
...
type ActionMenuItem = { icon: React.ReactNode; label: string; onClick: () => void; danger?: boolean } | 'separator' | null;
