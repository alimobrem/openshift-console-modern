...
function getCommandItems(
  ...
  if (mode === 'browse' || mode === 'default') {
    ...
    const builtinPages: CommandItem[] = [
      ...
      { type: 'nav', id: 'workloads', title: 'Workloads', subtitle: 'Deployments, StatefulSets, DaemonSets, Jobs', icon: 'Package', path: '/workloads' },
      { type: 'nav', id: 'networking', title: 'Networking', subtitle: 'Services, Ingresses, Routes, Policies', icon: 'Globe', path: '/networking' },
