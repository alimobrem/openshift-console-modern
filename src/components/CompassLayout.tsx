...
const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'jobs', name: 'Jobs & CronJobs', href: '/workloads/jobs' },
      { id: 'services', name: 'Services', href: '/networking/services' },
      { id: 'routes', name: 'Routes & Ingress', href: '/networking/routes' },
      { id: 'storage', name: 'Storage', href: '/storage/persistentvolumeclaims' },
      { id: 'secrets', name: 'Secrets & ConfigMaps', href: '/workloads/secrets' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'roles', name: 'Roles & Bindings', href: '/administration/roles' },
